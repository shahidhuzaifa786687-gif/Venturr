...
﻿(() => {
  ...
  const STORAGE = {
    listings: 'venturr_listings_v2',
    cart: 'venturr_cart_v1',
    user: 'venturr_user_v1'
  };
  ...
  function openLogin() {
    ...
    els.loginTitle.textContent = 'Welcome to Venturr';
